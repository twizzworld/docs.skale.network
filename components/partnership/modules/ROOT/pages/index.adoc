...
[NOTE]
We plan to roll out an automated certification platform in the future. For now, the knowledge certification will be complete by connecting directly with the SKALE Labs team. After completion of each module, please reach out to the SKALE Labs team to finalize the certification.
