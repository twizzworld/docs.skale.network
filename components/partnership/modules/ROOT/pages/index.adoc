...
If you are interested in becoming a channel or strategic consulting partner, please reach out https://skale.network/technology-partnerships[here].
...
Read up on the SKALE Network, what development tools can you use, how to get access to SKALE Chains, and where to reach out for help xref:introduction::overview.adoc[in the Basics doc].
