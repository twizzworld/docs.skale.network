...
Read up on the SKALE Network, what development tools can you use, how to get access to SKALE Chains, and where to reach out for help xref:introduction::index.adoc[in the Basics doc].
