...
Still not sure how to get started? Then head over to the https://docs.skale.network/develop/[Getting Started guide, window=_blank] or reach out to the http://skale.chat[SKALE Network developer community on Discord, window=_blank].
