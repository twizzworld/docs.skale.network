...
When it comes to setting up your own SKALE Proxy, it is recommending to use https://github.com/skalenetwork/proxy-provision[proxy-provision] as described below. 
