...
[NOTE]
====
The public chain provided above requires sFUEL to deploy contacts and perform transactions (faucet: https://sfuel.skale.network/staging/). This is unlike other SKALE chains which require both xref:skale-chain-access-control.adoc#_whitelist[deployer access] and sFUEL to deploy contracts.
