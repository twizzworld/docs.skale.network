...
6. `DA proof broadcast module`
7. `Consensus module`
8. `EVM module`.
9. `Block storage module` 
10 


```mermaid
flowchart TD
    b1[Network API] --> b2[Tx validation module] --> b3[Pending queue module] --> b5[Proposal Module] --> b6[DA proof broadcast module] --> b7[Consensus module] -->b8[EVM module]
    b2 --> b4[Tx broadcast module]    
```
