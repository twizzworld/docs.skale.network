...
SKALE Chain is a fixed set of $N$ network nodes that 
...
3. create block proposal for each block number and broadcast it to peers, collecting 2/3 $N$ data availability signature shares and creating DA signatures. (*proposal phase*)
4. broadcast DA signatures to peers (*DA broadcast phase*)
