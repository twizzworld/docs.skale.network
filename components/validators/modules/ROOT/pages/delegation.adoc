...
You may use https://activate.codefi.network/skale-network-launch-partner[ConsenSys Activate]'s platform with Metamask to view validators, make delegation proposals, and view received bounties. Read about ConsenSys Activate's process here: https://codefi.consensys.net/blog/activate-claiming-and-staking-guide 
