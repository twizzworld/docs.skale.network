...
* Activate users can continue to claim staking rewards and manage tokens using alternative methods like Unagii <<stakewithus_unagii, StakeWithUs Unagii>>.
...
** The value of accumulated rewards will NOT be impacted, and users will still be able to claim rewards at any point via Unagii <<stakewithus_unagii, StakeWithUs Unagii>>.
...
Activate users will not need to unstake to use Unagii, you may continue to claim rewards on Unagii without any changes.
====
