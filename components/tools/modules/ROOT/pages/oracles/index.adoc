...
xref:oracle[SKALE Oracle] is a native oracle built directly into each SKALE Chain. Using the same nodes that operate the SKALE Chain, the native oracle solution enables a variety of use cases.
